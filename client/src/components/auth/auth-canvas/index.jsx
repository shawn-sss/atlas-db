        ...
        <div className="start-body">
          <div className="start-main">
            <div className="start-auth-panel">
              {(title || description) && <div className="auth-hero">
                  <div className="auth-hero-brand">
                    <AppBrand title={brandTitle} subtitle={brandSubtitle} iconSrc={brandIcon} />
                  </div>
                  {title && <div className="auth-hero-title">{title}</div>}
                  {description && <div className="auth-hero-sub">{description}</div>}
                </div>}
              {children}
            </div>
          </div>
